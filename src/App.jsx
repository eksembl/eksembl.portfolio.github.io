...
function App() {
  ...
  return (
    <div className="font-sans scroll-smooth md:scroll-auto">
      {/* Fixed Header */}
      ...
      <section className="min-h-dvh bg-neutral-950 flex flex-col justify-center items-center py-12 pt-28 pl-60 pr-60">
        ...
        <div className="flex flex-col items-center justify-center gap-5">
          ...
          <div className="flex items-center justify-center gap-5">
            {/* GitHub */}
            <a className="size-10 flex items-center justify-center" href="https://eksembl.github.io" target="_blank" aria-label="GitHub">
              <svg
            ...
            {/* Discord */}
            <a className="size-10 flex items-center justify-center" href="https://discord.gg/ka4fBvYKtW" target="_blank" aria-label="Discord">
              <svg
                className="size-10 fill-neutral-100 hover:fill-neutral-400 transition-colors"
                role="img"
                viewBox="0 0 24 24"
      ...
      <section
        id="stack"
        className="min-h-dvh bg-neutral-100 text-neutral-900 p-8 flex flex-col justify-center items-center pl-60 pr-60"
      >
      ...
      <section
        id="info"
        className="min-h-dvh bg-neutral-950 text-neutral-900 p-8 flex flex-col justify-center items-center pl-60 pr-60"
      >
