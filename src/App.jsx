...
function App() {
  ...
  return (
    <div id="top" className="font-sans scroll-smooth">
      ...
      {/* Hero */}
      <section className="min-h-dvh bg-neutral-950 flex flex-col justify-center items-center py-12 pt-28 px-6">
        ...
        <div className="flex flex-col items-center justify-center gap-5">
          ...
          <div className="flex items-center justify-center gap-5">
            ...
            <a
              className="size-10 flex items-center justify-center"
              href="https://discord.gg/ka4fBvYKtW"
              target="_blank"
              rel="noreferrer"
              aria-label="Discord"
            >
      ...
      <section
        id="stack"
        ref={stackRef}
        className="min-h-dvh bg-neutral-950 text-neutral-100 px-6 py-24 flex flex-col justify-center items-center overflow-hidden"
      >
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
          ...
          <p
            className={`mt-5 text-center text-neutral-500 max-w-xl transition-all duration-1000 ease-out ${
              stackVisible
                ? 'translate-y-0 opacity-100'
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 md:gap-6 w-full">
            {STACK.map(({ name, icon: Icon }, i) => (
              <div
                key={name}
                style={{
                  transitionDelay: stackVisible
                    ? `${i * 80}ms`
                    : '0ms',
                }}
                className={`group flex flex-col items-center justify-center rounded-2xl border border-neutral-800 bg-neutral-900/40 p-6 min-h-36 transition-all duration-700 ease-out hover:-translate-y-2 hover:border-neutral-600 hover:bg-neutral-900 ${
                  stackVisible
                    ? 'translate-y-0 opacity-100'
              ...
              >
                <Icon
                  className="w-10 h-10 md:w-11 md:h-11 text-neutral-300 group-hover:text-white transition-colors"
                />

                <span className="mt-4 text-sm md:text-base font-medium text-neutral-400 group-hover:text-neutral-100 text-center transition-colors">
                  {name}
                </span>
              </div>
            ))}
      ...
      >
        ...
        <footer className="border-t border-neutral-800 py-8 px-8 flex flex-col items-center gap-5">
          <div className="flex items-center gap-6">
            ...
            >
              <svg
                className="size-8 fill-neutral-400 hover:fill-neutral-100 transition-colors"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div className="flex flex-col items-center gap-2 text-sm text-neutral-500">
            <p>
              © {new Date().getFullYear()} Eksembl. All rights reserved.
            </p>
